  ...
  return (
    <div className="px-4 xl:px-6">
      ...
      {/* <ModelNewProject
        ...
        isClose={() => setIsModalNewProjectOpen(false)}
      /> */}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <input
                ...
                className="rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-x-dark-secondary dark:bg-dark-secondary dark:text-white"
              />
